...
public class JsonArrayListTest {
	public static void main(String[] args) {
		...
		User user1 = new User(1L, "배승원", 23, "개발자");
...
//		반복 -> 생성자를 이용해서 JSONObject 객체화 JSONArray에 하나씩 put
		...
		users.stream().map((data)-> new JSONObject(data)).forEach((json)usersJSON.put(json));
		System.out.println(usersJSON);
	}
}
